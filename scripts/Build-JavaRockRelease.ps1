...
try {
    ...
    foreach ($required in @('START-JAVAROCK.bat', 'README-FIRST.txt', 'javarock-release-manifest.json', 'scripts/Start-JavaRock.ps1', 'scripts/JavaRock-Gui.ps1', 'scripts/New-JavaRockSupportBundle.ps1', 'scripts/redact-support-file.cjs', 'scripts/support-envelope.cjs', 'scripts/support-upload-http.cjs', 'scripts/Update-JavaRock.ps1', 'scripts/verify-release-integrity.cjs', 'scripts/javarock-update-http.cjs', 'src/index.js')) {

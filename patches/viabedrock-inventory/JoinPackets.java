        ...
        protocol.registerClientboundTransition(ClientboundBedrockPackets.PLAY_STATUS,
                State.LOGIN, (PacketHandler) wrapper -> {
                    ...
                    if (status == PlayStatus.LoginSuccess) {
                        ...
                        // Keep Bedrock's loading/initialization handshake pending. Vanilla Java
                        // sends PLAYER_LOADED only after LEVEL_CHUNKS_LOAD_START and the
                        // camera section has compiled; ClientPlayerEntity completes this
                        // handshake once ChunkTracker independently validates genuine terrain.
